...
public interface MobileCodeWSSoap {
    ...
    @RequestWrapper(localName = "getMobileCodeInfo", targetNamespace = "http://WebXml.com.cn/", className = "org.example.soap.ws.client.generated.GetMobileCodeInfo")
    @ResponseWrapper(localName = "getMobileCodeInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "org.example.soap.ws.client.generated.GetMobileCodeInfoResponse")
     ...
     * 
     * @return
     *     returns org.example.soap.ws.client.generated.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "getDatabaseInfo", targetNamespace = "http://WebXml.com.cn/", className = "org.example.soap.ws.client.generated.GetDatabaseInfo")
    @ResponseWrapper(localName = "getDatabaseInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "org.example.soap.ws.client.generated.GetDatabaseInfoResponse")
